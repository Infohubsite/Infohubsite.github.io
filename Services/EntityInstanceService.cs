...
namespace Frontend.Services
{
    ...
    public class EntityInstanceService(DefaultClient client) : IEntityInstanceService
    {
        ...
        public async Task<Result<EntityInstance>> UpdateInstanceAsync(Guid instanceId, UpdateInstanceDto updateDto) => await Client.UpdateInstance(instanceId, updateDto);
    }
